const MODULES = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { slug: '01-fundamentos-tecnologicos/07-como-funciona-una-aplicacion-moderna', title: 'Cómo funciona una aplicación moderna', level: 1, minutes: '30 min', outcome: 'Trazar el recorrido completo de una solicitud desde el usuario hasta la base de datos' },
    ],
  },
  {
  ...
  },
  {
    ...
    lessons: [
      ...
      { slug: '07-gentle-ai/05-comandos-del-ecosistema', title: 'Comandos del ecosistema', level: 2, minutes: '25 min', outcome: 'Distinguir entre CLI, TUI, slash command y fase interna' },
      { slug: '07-gentle-ai/06-actualizar-y-sincronizar', title: 'Actualizar y sincronizar', level: 2, minutes: '20 min', outcome: 'Distinguir entre update, upgrade y sync' },
      { slug: '07-gentle-ai/07-flujo-organico-y-rdd', title: 'Flujo orgánico y RDD', level: 3, minutes: '30 min', outcome: 'Explicar qué es un candidato congelado y cómo se revisa' },
    ],
  },
  {
  ...
  },
  {
    ...
    lessons: [
      ...
      { slug: '14-modelos-y-enrutamiento/02-asignar-modelos', title: 'Asignar modelos con perfiles y fallbacks', level: 2, minutes: '25 min', outcome: 'Configurar perfiles de modelos para fases SDD' },
  ...
  },
  {
    ...
    lessons: [
      ...
      { slug: '16-arquitectura-tecnica/02-arquitectura-gentle-y-hosts', title: 'Gentle-AI como configurador de ecosistema', level: 3, minutes: '25 min', outcome: 'Explicar por qué Gentle-AI es un configurador, no un agente' },
  ...
  },
  {
    ...
    lessons: [
      { slug: '19-laboratorios/01-laboratorios', title: 'Laboratorios', level: 2, minutes: '120 min', outcome: 'Completar 28 laboratorios progresivos y de maestría' },
      { slug: '19-laboratorios/02-solicitud-web', title: 'Trazar una solicitud web', level: 2, minutes: '45 min', outcome: 'Trazar una solicitud HTTP desde el navegador hasta la respuesta identificando cada capa' },
      { slug: '19-laboratorios/03-elegir-stack', title: 'Elegir un stack tecnológico', level: 2, minutes: '50 min', outcome: 'Evaluar opciones de stack y tomar una decisión documentada con ADR' },
      { slug: '19-laboratorios/04-escala-y-carga', title: 'Evolucionar un sistema bajo carga', level: 3, minutes: '60 min', outcome: 'Diagnosticar cuellos de botella y proponer una arquitectura evolutiva con evidencia' },
      { slug: '19-laboratorios/05-arquitectura-agentes', title: 'Diseñar una arquitectura de agentes', level: 3, minutes: '60 min', outcome: 'Diseñar un sistema multi-agente con roles, modelos y políticas de fallback' },
      { slug: '19-laboratorios/06-roles-y-modelos', title: 'Asignar roles y modelos con fallback', level: 3, minutes: '50 min', outcome: 'Configurar agentes OpenCode con modelos, reasoningEffort y cadenas de fallback' },
      { slug: '19-laboratorios/07-flujo-organico-rdd', title: 'Ejecutar un flujo orgánico y RDD', level: 3, minutes: '70 min', outcome: 'Implementar un cambio completo con Receipt-Driven Development y trazabilidad' },
      { slug: '19-laboratorios/08-revision-pr', title: 'Revisar una PR con confianza verificable', level: 2, minutes: '60 min', outcome: 'Revisar una PR usando native bounded review con receipt válido' },
      { slug: '19-laboratorios/09-capstone', title: 'Capstone completo', level: 3, minutes: '120 min', outcome: 'Construir, revisar y entregar un cambio completo desde spec hasta receipt' },
    ],
  },
  {
